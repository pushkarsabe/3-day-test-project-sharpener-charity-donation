...
exports.donateMoney = async (req, res, next) => {
    try {
        ...
        return res.status(201).json({ order, key_id: rzp.key_id, userOrder, message: 'Donation created successfully' });
    }
    catch (err) {
...
//         await sendEmail(donorEmail, donationAmount, transactionStatus);
